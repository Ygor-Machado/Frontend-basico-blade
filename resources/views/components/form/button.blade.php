<button
    ...
    {{ $attributes->class([
        ...
        "bg-white border-solid border text-blue-500 hover:border-blue-600 hover:text-blue-600 active:text-blue-900 disabled:border-gray-500 disabled:text-gray-500" => $variation === 'outline',
